...
flags.DEFINE_string('save_dir', '/cns/is-d/home/sherryy/teqdice/results/',
...
def build_experiment():
  ...
  executable = xm.BuildTarget(
      '//third_party/py/dice_rl/scripts:run_tabular_dual_dice',
  ...
  parameters = hyper.product([
      ...
      hyper.sweep('max_trajectory_length',
                  hyper.discrete([5, 10, 20, 50, 100, 200])),
  ])
