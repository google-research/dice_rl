...
"""Makes sure that scripts/run_neural_dice.py runs without error."""
...
from dice_rl.scripts import run_neural_dice


class RunNeuralDiceTest(tf.test.TestCase):

  def test_run_neural_dice(self):
    load_dir = 'testdata/'
    ...
    flags.FLAGS.tabular_obs = False
    flags.FLAGS.alpha = 0.
    flags.FLAGS.num_steps = 10
    run_neural_dice.main(None)
