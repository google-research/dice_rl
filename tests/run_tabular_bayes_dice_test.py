...
"""Makes sure that scripts/run_tabular_bayes_dice.py runs without error."""
...
from dice_rl.scripts import run_tabular_bayes_dice


class RunTabularBayesDiceTest(tf.test.TestCase):

  def test_run_tabular_bayes_dice(self):
    load_dir = 'testdata/'
    ...
    run_tabular_bayes_dice.main(None)
